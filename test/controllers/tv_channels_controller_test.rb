...
class TvChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv_channel" do
    assert_difference('TvChannel.count') do
      post tv_channels_url, params: { tv_channel: { description: @tv_channel.description, name: @tv_channel.name } }
    end
  ...
  test "should update tv_channel" do
    patch tv_channel_url(@tv_channel), params: { tv_channel: { description: @tv_channel.description, name: @tv_channel.name } }
